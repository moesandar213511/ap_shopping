            ...
            <div class="card">
              ...
              <?php 
                  ...
                  if(empty($_POST['search']) && empty($_COOKIE['search'])){
                    ...
                    $stmt = $pdo->prepare("SELECT * FROM categories ORDER BY id DESC LIMIT $offset,$numOfRecords");
                    $stmt->execute();
                    ...
                    $stmt = $pdo->prepare("SELECT * FROM categories WHERE name LIKE '%$search%' ORDER BY id DESC LIMIT $offset,$numOfRecords");
                    $stmt->execute();
                    $result = $stmt->fetchAll();
                  }
              ?>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="width:10%;">
                        ...
                        <div class="btn-group">
                          <div class="container">
                            <a href="category_edit.php?id=<?php echo $value['id'] ?>" type="button" class="btn btn-warning"><i class="fas fa-edit"></i><a>
                          </div>
                          <div class="container">
                            <a href="category_delete.php?id=<?php echo $value['id'] ?>" onclick="return confirm('Are you sure you want to delete this item')" type="button" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                          </div>
                        </div>
                      </td>
                    </tr>
